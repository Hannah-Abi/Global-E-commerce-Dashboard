...
bar_fig_country = px.bar(ecom_country, x='Total Sales ($)', y='Country', width=500, height=450, title='Total Sales by Country (Hover to filter)', custom_data=['Country'], color='Country', color_continuous_scale = 'redor')
bar_fig_country.update_layout({'bargap': 0.5})
...
app.layout = html.Div([
  ...
  html.H1('Sales breakdowns', style={'font-family':'Calibri'}),
  html.Div(
    children=[
    html.Div(
        children=[
        ...
        style={'color':'white','font-family':'Calibri(body)','background-color':'#811331','width':'330px', 'height':'300px', 'display':'inline-block', 'vertical-align':'top', 'padding':'10px'}),
    html.Div(children=[
